...
class MyOrderAdapter (internal var context: Context,
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Common.setSpanStringColor("Sipariş Tarihi " ,simpleDateFormat.format(orderList[position].createDate),
            holder.txt_time, Color.parseColor("#333639"))

        Common.setSpanStringColor("Sipariş Durumu " ,Common.convertStatusToString(orderList[position].orderStatus),
            holder.txt_order_status, Color.parseColor("#005758"))

        Common.setSpanStringColor("Sipariş Boyutu " ,if(orderList[position].cartItemList == null) "0"
            else orderList[position].cartItemList!!.size.toString(),
            holder.txt_num_item, Color.parseColor("#00574B"))

        Common.setSpanStringColor("İsim " ,orderList[position].userName,
