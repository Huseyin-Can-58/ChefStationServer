...
class MainActivity : AppCompatActivity() {
                ...
                override fun onDataChange(dataSnapShot: DataSnapshot) {
                    if(dataSnapShot.exists()){
                        ...
                        if(userModel!!.isActive){
                            ...
                            dialog!!.dismiss()
                            Toast.makeText(this@MainActivity,"Uygulamaya erişebilmek için yönetici tarafından onaylanmanız gerekmektedir",
    ...
    private fun showRegisterDialog(user: FirebaseUser) {
        ...
        builder.setTitle("Kayıt Ol")
        builder.setMessage("Lütfen gerekli bilgileri doldurun \n Yönetici daha sonra hesabı onaylayacak")
        ...
        builder.setNegativeButton("İPTAL",{dialogInterface, _ -> dialogInterface.dismiss()})
            .setPositiveButton("KAYDOL",{_, _ ->
                ...
                serverUserModel.isActive = false // Varsayılan olarak hatalı belirlendi,kullanıcıyı firebase konsoluncan onaylamak gerekiyor
                ...
                serverRef!!.child(serverUserModel.uid!!)
                    ...
                    .addOnCompleteListener { _ ->
                        dialog!!.dismiss()
                        Toast.makeText(this,"Kayıt Başarılı ! Yönetici yakında kontrol edecek ve kaydı aktifleştirecek",Toast.LENGTH_SHORT).show()
                    }
            })
